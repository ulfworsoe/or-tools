...
extern std::function<ResCode(Task_t,std::int32_t,std::int32_t,std::int64_t*)> get_barvar_slice_num_elm;
...
extern std::function<ResCode(Task_t,std::int64_t,std::int64_t*,const double*)> put_row_list_g;
...
extern std::function<ResCode(Task_t,std::int64_t,const std::int64_t*,const std::int64_t*,const std::int64_t*,NULLABLE const double*)> append_cons;
...
extern std::function<ResCode(Task_t,std::int32_t,std::int32_t,int[1],int[1])> get_sol_sta_x;
...
extern std::function<ResCode(Task_t,std::int32_t,std::int32_t,std::int32_t,int*,int*)> get_sol_sta_x_slice;
...
extern std::function<void(Task_t,std::int32_t,const double*)> put_all_double_params;
...
extern std::function<void(Task_t,std::int32_t,const std::int32_t*)> put_all_int_params;
...
extern std::function<std::int32_t(Task_t,const char*,double)> put_double_param;
extern std::function<std::int32_t(Task_t,const char*,std::int32_t)> put_int_param;
extern std::function<std::int32_t(Task_t,const char*,const char*)> put_param_str;
