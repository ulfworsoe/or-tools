...
extern std::function<ResCode(Task_t,std::int64_t,std::int64_t[1])> get_domain_svec_cone;
...
extern std::function<ResCode(Task_t,std::int64_t,std::int32_t*,std::int64_t*,const std::int32_t*,const std::int32_t*,const double*)> append_symmats;
