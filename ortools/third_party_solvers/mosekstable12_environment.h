...
extern std::function<ResCode(Task_t,const char*,double)> put_double_param;
extern std::function<ResCode(Task_t,const char*,std::int32_t)> put_int_param;
extern std::function<ResCode(Task_t,const char*,const char*)> put_param_str;
