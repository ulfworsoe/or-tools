...
std::function<ResCode(Task_t,std::int32_t,std::int32_t,std::int64_t*)> get_barvar_slice_num_elm;
...
std::function<ResCode(Task_t,std::int64_t,std::int64_t*,const double*)> put_row_list_g;
...
std::function<ResCode(Task_t,std::int32_t,std::int32_t,int[1],int[1])> get_sol_sta_x;
...
std::function<ResCode(Task_t,std::int32_t,std::int32_t,std::int32_t,int*,int*)> get_sol_sta_x_slice;
...
std::function<void(Task_t,std::int32_t,const double*)> put_all_double_params;
...
std::function<void(Task_t,std::int32_t,const std::int32_t*)> put_all_int_params;
...
std::function<std::int32_t(Task_t,const char*,double)> put_double_param;
std::function<std::int32_t(Task_t,const char*,std::int32_t)> put_int_param;
std::function<std::int32_t(Task_t,const char*,const char*)> put_param_str;
...
int initialize_library() {
    ...
    if (! loadsym(reserve_num_var,libmosek_handle,"MSK120_reserve_num_var")) goto ERROR;
    if (! loadsym(reserve_num_barvar,libmosek_handle,"MSK120_reserve_num_barvar")) goto ERROR;
    if (! loadsym(reserve_num_con,libmosek_handle,"MSK120_reserve_num_con")) goto ERROR;
    if (! loadsym(reserve_num_row,libmosek_handle,"MSK120_reserve_num_row")) goto ERROR;
    if (! loadsym(reserve_num_nz,libmosek_handle,"MSK120_reserve_num_nz")) goto ERROR;
    if (! loadsym(reserve_num_dom,libmosek_handle,"MSK120_reserve_num_dom")) goto ERROR;
    if (! loadsym(reserve_num_symmat,libmosek_handle,"MSK120_reserve_num_symmat")) goto ERROR;
    if (! loadsym(reserve_num_symmat_nz,libmosek_handle,"MSK120_reserve_num_symmat_nz")) goto ERROR;
    ...
    if (! loadsym(put_var_type_slice_value,libmosek_handle,"MSK120_put_var_type_slice_value")) goto ERROR;
    ...
    if (! loadsym(get_var_bound_slice,libmosek_handle,"MSK120_get_var_bound_slice")) goto ERROR;
    if (! loadsym(get_barvar_slice_num_elm,libmosek_handle,"MSK120_get_barvar_slice_num_elm")) goto ERROR;
    if (! loadsym(get_barvar_dim,libmosek_handle,"MSK120_get_barvar_dim")) goto ERROR;
    if (! loadsym(get_barvar_slice_dims,libmosek_handle,"MSK120_get_barvar_slice_dims")) goto ERROR;
    ...
    if (! loadsym(put_row_slice_g,libmosek_handle,"MSK120_put_row_slice_g")) goto ERROR;
    if (! loadsym(put_row_list_g,libmosek_handle,"MSK120_put_row_list_g")) goto ERROR;
    ...
    if (! loadsym(get_row_num_nz,libmosek_handle,"MSK120_get_row_num_nz")) goto ERROR;
    if (! loadsym(get_row_slice_num_nz,libmosek_handle,"MSK120_get_row_slice_num_nz")) goto ERROR;
    ...
    if (! loadsym(put_obj_sense,libmosek_handle,"MSK120_put_obj_sense")) goto ERROR;
    if (! loadsym(get_obj_sense,libmosek_handle,"MSK120_get_obj_sense")) goto ERROR;
    if (! loadsym(put_obj_row,libmosek_handle,"MSK120_put_obj_row")) goto ERROR;
    if (! loadsym(get_obj_row,libmosek_handle,"MSK120_get_obj_row")) goto ERROR;
    ...
    if (! loadsym(get_num_sol,libmosek_handle,"MSK120_get_num_sol")) goto ERROR;
    if (! loadsym(get_sol_type,libmosek_handle,"MSK120_get_sol_type")) goto ERROR;
    if (! loadsym(get_sol_status,libmosek_handle,"MSK120_get_sol_status")) goto ERROR;
    ...
    if (! loadsym(get_sol_xx_slice,libmosek_handle,"MSK120_get_sol_xx_slice")) goto ERROR;
    if (! loadsym(get_sol_slx_slice,libmosek_handle,"MSK120_get_sol_slx_slice")) goto ERROR;
    if (! loadsym(get_sol_sux_slice,libmosek_handle,"MSK120_get_sol_sux_slice")) goto ERROR;
    if (! loadsym(get_sol_barxj,libmosek_handle,"MSK120_get_sol_barxj")) goto ERROR;
    if (! loadsym(get_sol_barsj,libmosek_handle,"MSK120_get_sol_barsj")) goto ERROR;
    if (! loadsym(get_sol_barx_slice,libmosek_handle,"MSK120_get_sol_barx_slice")) goto ERROR;
    if (! loadsym(get_sol_bars_slice,libmosek_handle,"MSK120_get_sol_bars_slice")) goto ERROR;
    if (! loadsym(get_sol_basic_xj,libmosek_handle,"MSK120_get_sol_basic_xj")) goto ERROR;
    if (! loadsym(get_sol_basic_barx,libmosek_handle,"MSK120_get_sol_basic_barx")) goto ERROR;
    if (! loadsym(get_sol_basic_con,libmosek_handle,"MSK120_get_sol_basic_con")) goto ERROR;
    if (! loadsym(get_sol_sta_x,libmosek_handle,"MSK120_get_sol_sta_x")) goto ERROR;
    if (! loadsym(get_sol_sta_barx,libmosek_handle,"MSK120_get_sol_sta_barx")) goto ERROR;
    if (! loadsym(get_sol_sta_con,libmosek_handle,"MSK120_get_sol_sta_con")) goto ERROR;
    if (! loadsym(get_sol_basic_x_slice,libmosek_handle,"MSK120_get_sol_basic_x_slice")) goto ERROR;
    if (! loadsym(get_sol_basic_barx_slice,libmosek_handle,"MSK120_get_sol_basic_barx_slice")) goto ERROR;
    if (! loadsym(get_sol_basic_con_slice,libmosek_handle,"MSK120_get_sol_basic_con_slice")) goto ERROR;
    if (! loadsym(get_sol_sta_x_slice,libmosek_handle,"MSK120_get_sol_sta_x_slice")) goto ERROR;
    if (! loadsym(get_sol_sta_barx_slice,libmosek_handle,"MSK120_get_sol_sta_barx_slice")) goto ERROR;
    if (! loadsym(get_sol_sta_con_slice,libmosek_handle,"MSK120_get_sol_sta_con_slice")) goto ERROR;
    if (! loadsym(get_sol_y_slice,libmosek_handle,"MSK120_get_sol_y_slice")) goto ERROR;
    if (! loadsym(get_num_input_solutions,libmosek_handle,"MSK120_get_num_input_solutions")) goto ERROR;
    if (! loadsym(copy_sol_to_input,libmosek_handle,"MSK120_copy_sol_to_input")) goto ERROR;
    if (! loadsym(append_sol,libmosek_handle,"MSK120_append_sol")) goto ERROR;
    ...
    if (! loadsym(get_double_param,libmosek_handle,"MSK120_get_double_param")) goto ERROR;
    if (! loadsym(get_double_param_index,libmosek_handle,"MSK120_get_double_param_index")) goto ERROR;
    if (! loadsym(get_double_param_name,libmosek_handle,"MSK120_get_double_param_name")) goto ERROR;
    if (! loadsym(get_num_double_param,libmosek_handle,"MSK120_get_num_double_param")) goto ERROR;
    if (! loadsym(get_all_double_params,libmosek_handle,"MSK120_get_all_double_params")) goto ERROR;
    if (! loadsym(put_all_double_params,libmosek_handle,"MSK120_put_all_double_params")) goto ERROR;
    if (! loadsym(get_int_param_index,libmosek_handle,"MSK120_get_int_param_index")) goto ERROR;
    if (! loadsym(get_int_param_name,libmosek_handle,"MSK120_get_int_param_name")) goto ERROR;
    if (! loadsym(get_num_int_param,libmosek_handle,"MSK120_get_num_int_param")) goto ERROR;
    if (! loadsym(get_all_int_params,libmosek_handle,"MSK120_get_all_int_params")) goto ERROR;
    if (! loadsym(put_all_int_params,libmosek_handle,"MSK120_put_all_int_params")) goto ERROR;
    if (! loadsym(get_int_param,libmosek_handle,"MSK120_get_int_param")) goto ERROR;
    if (! loadsym(get_param_str_len,libmosek_handle,"MSK120_get_param_str_len")) goto ERROR;
    if (! loadsym(get_param_str,libmosek_handle,"MSK120_get_param_str")) goto ERROR;
    if (! loadsym(put_double_param,libmosek_handle,"MSK120_put_double_param")) goto ERROR;
    if (! loadsym(put_int_param,libmosek_handle,"MSK120_put_int_param")) goto ERROR;
    if (! loadsym(put_param_str,libmosek_handle,"MSK120_put_param_str")) goto ERROR;
